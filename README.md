...
```scala
libraryDependencies += "com.stackmob" % "stackmob-java-client-sdk" % "0.5.5"
```

## Commandline (or Ant)

Download the [StackMob Java SDK](http://search.maven.org/remotecontent?filepath=com/stackmob/stackmob-java-client-sdk/0.5.5/stackmob-java-client-sdk-0.5.5.jar) and the dependencies listed below and place them on your CLASSPATH:
...
The main interface to your app on StackMob's servers is through the ``` com.stackmob.sdk.api.StackMob ``` object. Check out the [javadoc](http://stackmob.github.com/stackmob-java-client-sdk/javadoc/0.5.5/apidocs/) for details.
