...
[![Build Status](https://travis-ci.org/stackmob/stackmob-java-client-sdk.png?branch=master)](https://travis-ci.org/stackmob/stackmob-java-client-sdk)
...
```scala
libraryDependencies += "com.stackmob" % "stackmob-java-client-sdk" % "1.3.0"
```

## Commandline (or Ant)

Download the [StackMob Java SDK](http://search.maven.org/remotecontent?filepath=com/stackmob/stackmob-java-client-sdk/1.3.0/stackmob-java-client-sdk-1.3.0.jar) and the dependencies listed below and place them on your CLASSPATH:
