...
```scala
libraryDependencies += "com.stackmob" % "stackmob-java-client-sdk" % "0.5.6"
```

## Commandline (or Ant)

Download the [StackMob Java SDK](http://search.maven.org/remotecontent?filepath=com/stackmob/stackmob-java-client-sdk/0.5.6/stackmob-java-client-sdk-0.5.6.jar) and the dependencies listed below and place them on your CLASSPATH:
